...
png("~/Coursera/Exploratory Data Analysis/CourseProject1/plot4.png",480,480)
par(mfcol=c(2,2),mar=c(4.5,4.5,3,1))
...
with(household_power_consumption_dates,plot(datetime,Voltage,type="l"))
with(household_power_consumption_dates,plot(datetime,Global_reactive_power,type="l"))
dev.off()